...
export class JSEncrypt {
    ...
    public decryptUnicodeLong(str:string) {
        // Return the decrypted string.
        try {
            return this.getKey().decryptUnicodeLong(str);
        } catch (ex) {
            return false;
        }
    }
    ...
    public encryptUnicodeLong(str:string) {
        // Return the encrypted string.
        try {
            return this.getKey().encryptUnicodeLong(str);
        } catch (ex) {
            return false;
        }
    }

    // public decryptUnicodeLong1(str:string) {
    //     // Return the decrypted string.
    //     try {
    //         return this.getKey().decryptUnicodeLong1(str);
    //     } catch (ex) {
    //         return false;
    //     }
    // }

    // public encryptUnicodeLong1(str:string) {
    //     // Return the encrypted string.
    //     try {
    //         return this.getKey().encryptUnicodeLong1(str);
    //     } catch (ex) {
    //         return false;
    //     }
    // }
